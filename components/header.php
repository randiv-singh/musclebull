...
<!-- Navigation -->
<nav
    class="navbar navbar-expand-lg <?php echo $type === 'transparent' ? 'position-absolute w-100 z-3 navbar-glass' : 'navbar-static bg-white'; ?>">
    <div class="container-fluid px-4">
        <a class="navbar-brand d-flex align-items-center gap-2" href="index.php">
            <img src="./assets/images/logo/mb logo.png" alt="Muscle Bull Logo" height="40">
            <span
                class="fw-bold text-uppercase <?php echo $type === 'transparent' ? 'text-white' : 'text-black'; ?> brand-text">Muscle
                Bull</span>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto nav-center">
                <li class="nav-item">
                    <a class="nav-link <?php echo $type === 'transparent' ? 'text-white' : 'text-black'; ?> fw-medium text-uppercase <?php echo $active_page === 'shop' ? 'active' : ''; ?>"
                        href="shop.php">Shop</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo $type === 'transparent' ? 'text-white' : 'text-black'; ?> fw-medium text-uppercase <?php echo $active_page === 'gift-cards' ? 'active' : ''; ?>"
                        href="gift-cards.php">Gift Cards</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo $type === 'transparent' ? 'text-white' : 'text-black'; ?> fw-medium text-uppercase <?php echo $active_page === 'about' ? 'active' : ''; ?>"
                        href="about.php">About</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo $type === 'transparent' ? 'text-white' : 'text-black'; ?> fw-medium text-uppercase <?php echo $active_page === 'contact' ? 'active' : ''; ?>"
